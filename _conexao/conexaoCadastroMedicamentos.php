...
$cadastro = ("INSERT INTO `cadastrar_medicamento` (`lote_medicamento`, `nome_item`, `data_entrada`, `qtd_lote`, `data_validade`, `forma_farmaceutica`, `concentracao`, `login_idlogin`)
    VALUES('$lote', '$nome', '$dataEntrada', '$qtdLote', '$dataValidade', '$forma', '$concentracao', '$login')");
