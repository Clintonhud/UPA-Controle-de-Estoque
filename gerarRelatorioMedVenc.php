...
$sql = $pdo->query("SELECT * FROM `cadastrar_medicamento` WHERE vencimento = 1 AND data_entrada BETWEEN '$data_inicial' AND '$data_fim' ORDER BY data_validade");

$html = '<center><h1> Relatorio de Medicamentos Vencidos</h1></center>';
