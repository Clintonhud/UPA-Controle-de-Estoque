...
$sql = $pdo->query("SELECT * FROM `cadastrar_itens_laboratoriais` WHERE vencimentol = 0 AND data_entradal BETWEEN '$data_inicial' AND '$data_fim' ORDER BY data_entradal");
