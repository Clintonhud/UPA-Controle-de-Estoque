...
?>
    ...
    <body>
        ...
        <div id="resultado">
            ...
            $sql = ("SELECT * FROM cadastrar_itens_laboratoriais WHERE vencimentol = 0 ORDER BY data_validadel");
        ...
        <table>
            ...
            ?>
                ...
                <TD><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModal" data-whatever="<?php echo $tbl['lote_laboratorio']; ?>"><svg width="25px" height="25px" viewBox="0 0 16 16" class="bi bi-file-minus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M4 1h8a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H4z" />
                            <path fill-rule="evenodd" d="M5.5 8a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1-.5-.5z" />
                        </svg></button></TD>

                <TD><button type="button" role="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModalvencidos" data-whatever="<?php echo $tbl['lote_laboratorio']; ?>"><svg width="25px" height="25px" viewBox="0 0 16 16" class="bi bi-calendar2-event-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <TD><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo $tbl['lote_laboratorio']; ?>"><svg width="25px" height="25px" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Modal Vencimento -->
        <form method="POST" action="_conexao/lab_vencido.php">
            <div class="modal fade" id="myModalvencidos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <center>
                            <div class="modal-body">
                                Este item já está vencido?
                            </div>
                            <div class="form-row">
                                <input id="lote_lab_venc" type="hidden" name="lote_lab_venc">
                            </div>
                        </center>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Não</button>
        ...
        <script type="text/javascript">
            $('#myModalvencidos').on('show.bs.modal', function(event) {
                ...
                // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
                var modal = $(this)
                modal.find('#lote_lab_venc').val(recipient)
            })
        </script>
